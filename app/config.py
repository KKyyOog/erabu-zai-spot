...
class Config:
    ...
    NOTIFICATION_JOB_STALE_SECONDS = int(os.getenv("NOTIFICATION_JOB_STALE_SECONDS", "900"))
    SENT_NOTIFICATION_RETENTION_DAYS = int(os.getenv("SENT_NOTIFICATION_RETENTION_DAYS", "30"))
    OPERATION_LOG_RETENTION_DAYS = int(os.getenv("OPERATION_LOG_RETENTION_DAYS", "30"))
